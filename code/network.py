...
class Unet(pl.LightningModule):
    def __init__(self,learning_rate=1e-3):
        ...
        self.o_16_encode_side = Network_Utility.conv_3d(1, 32)
        self.o_16_encode_down = Network_Utility.down_conv_3d(32, 32)
        self.o_32_encode_side = Network_Utility.conv_3d(32, 64)
        self.o_32_encode_down = Network_Utility.down_conv_3d(64, 64)
        self.o_64_encode_side = Network_Utility.conv_3d(64, 128)
        self.o_64_encode_down = Network_Utility.down_conv_3d(128, 128)
        self.o_128_encode_side = Network_Utility.conv_3d(128, 256)
        self.o_128_encode_down = Network_Utility.down_conv_3d(256, 256)
        self.o_256_encode_side = Network_Utility.conv_3d(256, 512)
        self.o_128_decode_up = Network_Utility.up_conv_3d(512, 256)
        self.o_128_decode_side = Network_Utility.conv_3d(512, 256)
        self.o_64_decode_up = Network_Utility.up_conv_3d(256, 128)
        self.o_64_decode_side = Network_Utility.conv_3d(256, 128)
        self.o_32_decode_up = Network_Utility.up_conv_3d(128, 64)
        self.o_32_decode_side = Network_Utility.conv_3d(128, 64)
        self.o_16_decode_up = Network_Utility.up_conv_3d(64, 32)
        self.o_16_decode_side = Network_Utility.conv_3d(64, 32)
        self.o_1_decode_side = Network_Utility.final_conv_3d(33, 1)
